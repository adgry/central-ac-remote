...
（[添加室内机](screenshots/03-添加室内机.png) · [设置](screenshots/04-设置.png)）
...
手机基本都没有红外发射口了，所以需要一台**红外桥**：一块 ESP8266/ESP32 加一颗红外
发射管，放在线控器附近，红外灯对准那个小黑点。固件是 `docs/ir-bridge.ino`，
接线、引脚、接口都写在文件开头。通电后把它的 IP 填进 app。
